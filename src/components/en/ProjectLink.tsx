  ...
  return (
    <Link className="slideUp relative w-[58rem]" href={linkToPage}>
      <Image
        ...
        height={800}
      />
      <div className="projectLinkAnimation absolute left-0 top-0 flex h-full w-full items-end justify-start bg-[rgba(0,0,0,0.6)] uppercase text-white opacity-0 transition-opacity hover:opacity-100">
