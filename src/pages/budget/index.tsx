    ...
    <>
      ...
      <Inner>
        ...
        <div className="min-w-minimum">
          <div className="mx-[11.25rem] mb-28 flex gap-6 max-xl:mx-[5.5rem] max-xl:mb-24 max-xl:flex-col max-xs:mx-8 max-xs:mb-12">
            ...
            <div className="h-[37rem] grow overflow-hidden rounded-lg max-xl:h-[62.5rem] max-xs:h-[28rem]">
              <Form />
            </div>
          </div>
        </div>
